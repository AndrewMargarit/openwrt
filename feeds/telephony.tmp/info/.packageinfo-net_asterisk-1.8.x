...
Maintainer: 
Source: asterisk-1.8.26.0.tar.gz
Type: ipkg
...
Submenu: Telephony
Version: 1.8.26.0-1
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 +libpthread +unixodbc
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Submenu: Telephony
Version: 1.8.26.0-1
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 +libpq
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Submenu: Telephony
Version: 1.8.26.0-1
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 +libpthread +liblua
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Package: asterisk18-app-followme
Submenu: Telephony
Version: 1.8.26.0-1
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 +PACKAGE_asterisk18-app-followme:asterisk18-chan-local
Menu-Depends: 
Provides: 
Section: net
Category: Network
Title: FollowMe application support
Maintainer: 
Source: asterisk-1.8.26.0.tar.gz
Type: ipkg
Description:    Asterisk is a complete PBX in software. It provides all of the features
 ...
 protocols, and can interoperate with almost all standards-based telephony
 equipment using relatively inexpensive hardware.
    This package provides support support for FollowMe functionality in Asterisk.
http://www.asterisk.org/
...
Description:    Asterisk is a complete PBX in software. It provides all of the features
 ...
 protocols, and can interoperate with almost all standards-based telephony
 equipment using relatively inexpensive hardware.
    This package provides support Counts the number of channels in the specified group in Asterisk.
http://www.asterisk.org/
